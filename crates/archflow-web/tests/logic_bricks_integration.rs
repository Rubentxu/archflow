...
use archflow_web::engine::ArchFlowEngine;
use archflow_web::logic_bricks_setup::LogicBricksSystem;
...
fn test_engine_with_logic_bricks() {
    ...
    assert_eq!(engine.logic_bricks.batch_select.selection_count(), 0);
