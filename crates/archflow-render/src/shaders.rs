...
/// GLSL SDF Shapes shader (generated by build.rs)
#[cfg(feature = "webgl2")]
pub const SHADER_SDF_SHAPES_GLSL: &str = include_str!(concat!(env!("OUT_DIR"), "/sdf_shapes.glsl"));

/// GLSL Icon texture shader (generated by build.rs)
#[cfg(feature = "webgl2")]
pub const SHADER_ICON_TEXTURE_GLSL: &str =
    include_str!(concat!(env!("OUT_DIR"), "/icon_texture.glsl"));

/// GLSL Image array shader (generated by build.rs)
#[cfg(feature = "webgl2")]
pub const SHADER_IMAGE_ARRAY_GLSL: &str =
    include_str!(concat!(env!("OUT_DIR"), "/image_array.glsl"));

/// GLSL MTSDF text shader (generated by build.rs)
#[cfg(feature = "webgl2")]
