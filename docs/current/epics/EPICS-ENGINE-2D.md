...
| **archflow-ecs** | 0.5.0 | ✅ Completo |
| **archflow-geometry** | 0.5.0 | ✅ Completo |
| **archflow-primitives** | 0.5.0 | ✅ Completo |
| **archflow-renderer** | 0.5.0 | ✅ Completo |
| **archflow-renderer-canvas** | 0.5.0 | ✅ Completo |
| **archflow-renderer-rough** | 0.5.0 | ✅ Completo |
| **archflow-wasm** | 0.5.0 | ✅ Completo |
...
- `archflow-ecs/src/lib.rs`:
  - `Transform` wrapper component (translation, rotation, scale)
